...
DO NOT CHANGE ANYTHING IN FILES EXCEPT is-cycle.cpp AS WE WILL ONLY TAKE YOUR is-cycle.cpp FILE FOR EVALUATION.
...
4. You have been provided with 6 sample testcases (tests directory). 
   These testcases by no means cover all possible testcases (as usual :|)
